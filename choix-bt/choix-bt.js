...
function selection(color) {
  // enft color c el nom que tu choiosis a lelement quon va prendre dcp avant ct un nombre et tu te bases sur ca pr appliquer cque tu veux aux elements
...
function next() {
  // fonction qui regarde si il y a une selection dcp tu peux appuyer mais tant quil nen pas ca fera rien
  if (selected != "") {
    // si selected nest pas egal a rien (uen couleur est selectionne ) alors on peut aller sur le bb de la couleur choisie, sinon il se passe rien (dcp quand tu appuies sur le bouton ca fait rien)
